 ...
 *******************************************************************************/
package org.eclipse.wst.ide.remote.ui.internal;
...
import org.eclipse.wst.ide.remote.ui.internal.view.MonitorView;
/**
...
public class MonitorPreferencePage extends PreferencePage implements IWorkbenchPreferencePage, IShellProvider {
	...
	protected static List<Object> selection2;
	...
	protected void setSelection(ISelection sel2) {
		...
		if (!selection2.isEmpty()) {
			...
			MonitorView.start.setEnabled(allStopped);
			stop.setEnabled(allStarted);
			MonitorView.stop.setEnabled(allStarted);
