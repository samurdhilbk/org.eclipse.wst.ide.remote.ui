...
import org.eclipse.wst.ide.remote.ui.internal.custom.SashForm;
import org.eclipse.wst.ide.remote.ui.internal.provisional.ContentViewer;
import org.eclipse.wst.ide.remote.ui.internal.viewers.ByteViewer;
import org.eclipse.wst.ide.remote.ui.internal.viewers.HeaderViewer;
/**
 * 
 */
public class ViewerManager {
	...
	protected Viewer getDefaultViewer(String name) {
		...
		if (name2.endsWith(".xml"))
			return findViewer("org.eclipse.wst.ide.remote.viewers.xml");
		else if (name2.endsWith(".html"))
			return findViewer("org.eclipse.wst.ide.remote.viewers.browser");
		else if (name2.endsWith(".gif") || name2.endsWith(".jpg") ||
				name2.endsWith(".jpeg") || name2.endsWith(".png"))
			return findViewer("org.eclipse.wst.ide.remote.viewers.image");
		else
			return findViewer("org.eclipse.wst.ide.remote.viewers.byte");
	}
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.ide.remote.internal.view.IViewerManager#setDisplayHeaderInfo(boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.ide.remote.internal.view.IViewerManager#getDisplayHeaderInfo()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.ide.remote.ui.internal.view.IViewerManager#getCurrentRequestViewer()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.ide.remote.ui.internal.view.IViewerManager#getCurrentRequestHeaderViewer()
	 */
